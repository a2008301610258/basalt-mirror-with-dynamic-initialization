...
//                    PointCloudXYZINormal &pcl_in_out);
  ...
  StatesGroup imu_preintegration(const StatesGroup &state_inout,
                                 std::deque<ImuTypeData> &v_imu);
//  ros::NodeHandle nh;

//  void Integrate(const sensor_msgs::ImuConstPtr &imu);
//  void Reset(double start_timestamp, const ImuTypeData &lastimu);
